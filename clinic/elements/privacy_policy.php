...
<head>
    ...
    <style>
        ...
        body {
            margin-top: 3cm; /* Margines 3 cm od góry strony */
        ...
        /* Styl dla preambuły */
        .headline {
            margin-top: 20px; /* Margines od nagłówka */
            text-align: left; /* Wyśrodkowanie tekstu */
            color: navy;
        }
        /* Styl dla tekstu preambuły */
        .tekst-preambuly {
            text-align: left; /* Wyjustowanie tekstu do lewej */
            margin-top: 20px; /* Margines od preambuły */
            max-width: 800px; /* Maksymalna szerokość tekstu */
            margin-left: auto; /* Wyśrodkowanie tekstu na szerokość strony */
            margin-right: auto; /* Wyśrodkowanie tekstu na szerokość strony */
        }
    </style>
</head>
<body>
<div class="container">
    <!-- Nagłówek h2 - Polityka prywatności -->
    ...
    <!-- Tekst preambuły -->
    <div class="tekst-preambuly">
        <p>W Grupie Lyreco uważamy, że ochrona prywatności jest niezwykle ważna, dlatego stworzyliśmy kompleksowy Program Ochrony Prywatności, globalne Biuro ds. Prywatności oraz stanowisko Chief Privacy Officer, które mają nam pomóc chronić Twoje prawo do prywatności.
            ...
            W niniejszej Polityce Prywatności wyrażenia „Ty", „Twój" odnoszą się do każdej osoby fizycznej, której Dane Osobowe są przetwarzane przez Lyreco, zaś wyrażenia "my", "nasz", "nas", odnoszą się do Lyreco.</p>
    </div>
    <div class="headline">
        <h4><b>1. Definicje</b></h4>
    </div>

    <!-- Tekst preambuły -->
    <div class="tekst-preambuly">
        <p>1.1 "Spółki zależne" oznaczają podmioty z Grupy Lyreco, kontrolowane przez Lyreco France S.A.S.
            ...
            1.8 "Użytkownik" oznacza każdą osobę korzystającą z serwisu internetowego Lyreco (np. lyreco.com) lub fanpage, profilu lub kanału Lyreco w portalu społecznościowym (np. Facebook).</p>
    </div>

    <div class="headline">
        <h4><b>2. Zobowiązanie Przychodni</b></h4>
    </div>

    <!-- Tekst preambuły -->
    <div class="tekst-preambuly">
        <p>Niniejsza polityka prywatności dotyczy wyłącznie Danych Osobowych przetwarzanych przez Lyreco.

            Lyreco przetwarza Dane Osobowe w sposób rzetelny i zgodnie z Przepisami o Ochronie Danych Osobowych.

            W przypadku jakiegokolwiek konfliktu pomiędzy niniejszą Polityką Prywatności a Przepisami o Ochronie Danych Osobowych, pierwszeństwo mają postanowienia obowiązujących Przepisów o Ochronie Danych Osobowych.</p>
    </div>


    <div class="headline">
        <h4><b>3. Jakie Dane Osobowe zbieramy i przetwarzamy?</b></h4>
    </div>
    ...
    <div class="tekst-preambuly">
        <p>W związku z prowadzoną działalnością, w szczególności dostarczaniem produktów lub świadczeniem usług Klientowi, Lyreco przetwarza Dane Osobowe dotyczące wielu różnych kategorii osób. Szczegółowy zakres przetwarzanych przez Lyreco Danych Osobowych, wskazany został w Załączniku nr 1 do niniejszej Polityki Prywatności.
            ...
            Dane Osobowe wszystkich osób odwiedzających Lyreco są przetwarzane w zakresie zawartym w książkach gości, książkach zarządzania parkingami, monitoringu przemysłowym, dokumentacji zapewniającej zgodność z wymogami dotyczącymi zapobiegania rozprzestrzeniania się COVID-19 oraz innymi rejestrami prowadzonymi w celu umożliwienia wstępu na teren Lyreco oraz odbycia spotkania.</p>
    </div>
