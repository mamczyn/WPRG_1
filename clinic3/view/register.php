...
<style>
    ...
    body {
        background-image: url('../assets/images/Krynka_przychodnia_rejestracja.webp');
        ...
        <div class="col-md-6">
            ...
            <div class="card my-5">
                <div class="card-body">
                    ...
                    <form action="../users/controler_1/add_patient.php" method="post">
                        ...
                        <div class="form-group mb-4">
                            <input type="submit" class="btn btn-primary w-100" value="Rejestracja">
                        </div>
